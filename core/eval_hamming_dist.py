...
for input_param in input_params:
    for time_param in time_params:
        ...
        for i in range(num_exp):
            ...
            NRMSE, fitness = hamming_dist(input_params=input_param, time_params=time_param, num_epoch=num_epoch)
...
df_fitness.to_csv('dat/HD_fitness_{}ep_{}ex.csv'.format(num_epoch, num_exp), index=False)
