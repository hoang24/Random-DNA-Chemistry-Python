...
# NRMSE, fitness = short_term_memory(input_params=input_params5, time_params=time_params1, num_epoch=10, plot_chem=False, error_plot=False)
# NRMSE, fitness = long_term_memory(input_params=input_params5, time_params=time_params1, num_epoch=10, plot_chem=False, error_plot=False)
